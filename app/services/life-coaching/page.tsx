          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">Life Coaching for Students</h1>
                  <p className="text-lg text-white/80">Personal growth and self-discovery sessions</p>
                </div>
              </div>
            </div>
          </div>
